...
def subjects_class():
    codesql = text('''SELECT sub.title as Subject, 
        usr.first_name || ' ' || usr.last_name as Instructor, 
        cl.delivery_mode as DeliveryMode, cl.detail as Details, 
        sub.description as Descriptions, sub.credits as Credits, 
        cl.status as Status FROM classes cl 
